...
public class SunshineService extends IntentService{
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        //Take out the location query from Intent extra
    ...
    //Inner class to handle broadcast intents for the purpose of updating weather data
    //based on some alarm. Further this is a new component hence we register it in
    //android manifest.
    ...
    public static class AlarmReceiver extends BroadcastReceiver
    {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            //Create a new explicit intent to launch the SunshineService
            Intent sunshineServiceIntent = new Intent(context, SunshineService.class);

            //get and set the intent extra
